...
echo 'export/android/adb = "/root/android/sdk/platform-tools/adb"' >> ~/.config/godot/editor_settings-3.tres
echo 'export/android/jarsigner = "/root/android/sdk/build-tools/jarsigner"' >> ~/.config/godot/editor_settings-3.tres
